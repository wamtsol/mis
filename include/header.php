...
<body>
	<div id="wrapper" class="round_corners">		
    	<div id="top" class="clearfix">
            <div class="applogo">
                <a href="index.php" class="logo"><?php $admin_logo=get_config("admin_logo"); ?><img src="<?php echo $file_upload_root;?>config/<?php echo $admin_logo?>" /></a>
            </div>
        ...
        <div class="sidebar clearfix" style="display:none">
