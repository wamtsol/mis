...
<div class="page-header">
	<h1 class="title">Edit Scheduled Transaction</h1>
  	<ol class="breadcrumb">
    	<li class="active">
        	<?php
...
<form class="form-horizontal form-horizontal-left" role="form" action="scheduled_transaction_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="Update" class="btn btn-default btn-l" name="scheduled_transaction_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>