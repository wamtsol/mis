...
<div class="page-header">
	<h1 class="title">Edit Holidays</h1>
  	<ol class="breadcrumb">
...
<form action="holidays_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd"  class="form-horizontal form-horizontal-left">
	<input type="hidden" name="id" value="<?php echo $id;?>">
  	...
  	<div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="UPDATE" class="btn btn-default btn-l" name="holidays_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>