...
if(isset($_GET["employee_id"])){
	...
	$_SESSION["salary"]["list"]["employee_id"]=$employee_id;
}
if(isset($_SESSION["salary"]["list"]["employee_id"]))
	$employee_id=$_SESSION["salary"]["list"]["employee_id"];
else
	$employee_id="";
if($employee_id!=""){
	...
	<h1 class="title">Manage Salary</h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="salary_manage.php?tab=add" class="btn btn-light editproject">Add New Salary</a> 
...
<div class="panel-body table-responsive">
	<table class="table table-hover list">
        ...
        <tbody>
            <?php 
            $sql="select * from salary where 1 ".$extra." order by year desc, month desc";
