...
<form class="form-horizontal form-horizontal-left form-employee_salary" role="form" action="employee_salary_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();">
    <?php
        $i=0;
    ?>
