...
<div class="page-header">
	<h1 class="title">Manage Employee Salary</h1>
  	<ol class="breadcrumb">
    	<li class="active">Employee Employee Salary</li>
  	</ol>
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="employee_salary_manage.php?tab=add" class="btn btn-light editproject">Add New Employee Salary</a> 
            <a id="topstats" class="btn btn-light" href="#"><i class="fa fa-search"></i></a>
            <a class="btn print-btn" href="employee_salary_manage.php?tab=report"><i class="fa fa-print" aria-hidden="true"></i></a>
            <a class="btn print-btn" href="employee_salary_manage.php?tab=report_csv">CSV</a>
    	</div> 
    </div> 
</div>
        	...
        	<form class="form-horizontal" action="" method="get">
            	<div class="col-sm-2 margin-btm-5">
                	<select name="employee_id" id="employee_id" class="custom_select">
                        ...
                        <?php
							$res=doquery("select * from employee order by name",$dblink);
							if(numrows($res)>=0){
                ...
                <div class="col-sm-2 margin-btm-5">
                    <input type="text" title="Enter Date From" value="<?php echo $from?>" placeholder="Date From" name="date_from" id="date_from" class="form-control date-picker active" autocomplete="off">
                </div>
                <div class="col-sm-2 margin-btm-5">
                    <input type="text" title="Enter Date To" value="<?php echo $to?>" placeholder="Date To" name="date_to" id="date_to" class="form-control date-picker active" autocomplete="off">
                </div>
        ...
        <tbody>
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="employee_salary_manage.php?id=<?php echo $r['id'];?>&tab=status&s=<?php echo ($r["status"]==0)?1:0;?>">
                                <?php
                                if($r["status"]==0){
                                    ?>
                ...
                <tr>
                    ...
                    <td colspan="3" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "employee_salary", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
