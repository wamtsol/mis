...
if(isset($_GET["employee_id"])){
	...
	$_SESSION["salary_payment"]["list"]["employee_id"]=$employee_id;
}
if(isset($_SESSION["salary_payment"]["list"]["employee_id"]))
	$employee_id=$_SESSION["salary_payment"]["list"]["employee_id"];
else
	$employee_id="";
if($employee_id!=""){
	...
	<h1 class="title">Manage Salary Payment</h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="salary_payment_manage.php?tab=add" class="btn btn-light editproject">Add New Salary Payment</a> 
...
<div class="panel-body table-responsive">
	<table class="table table-hover list">
        ...
        <tbody>
            <?php 
            $sql="select * from salary_payment where 1 ".$extra." order by ts desc";
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            	<a href="salary_payment_manage.php?tab=edit&id=<?php echo $r['id'];?>"><img title="Edit Record" alt="Edit" src="images/edit.png"></a>&nbsp;&nbsp;
                            	<a onclick="return confirm('Are you sure you want to delete')" href="salary_payment_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a>
                        </td>
                    </tr>  
                    <?php 
                    $sn++;
