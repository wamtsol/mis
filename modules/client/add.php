...
if(isset($_SESSION["client_manage"]["add"])){
	extract($_SESSION["client_manage"]["add"]);	
}
else{
	$client_name="";
	$representative_name="";
...
<form action="client_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();" class="form-horizontal form-horizontal-left">
	<?php
    	$i=0;
  	?>
    ...
    <div class="form-group">
  	...
  	<div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="SUBMIT" class="btn btn-default btn-l" name="client_add" title="Submit Record" />
            </div>
        </div>
  	</div>
</form>